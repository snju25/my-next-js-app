...
const page = () => {
  return (
    <div className="bg-[#101523] min-h-screen pt-40 flex flex-col items-center gap-10">
        ...
        <p className="mx-auto max-w-[500px] text-center text-neutral-400">We're here to help with any questions about our course, programs, or events. Reach out and let us know how we can assist you in your musical journey.</p>
